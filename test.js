...
assert.equal(contents(`${TODAY_INPUT} | ${TODAY_INPUT}`), `${TODAY_OUTPUT}${TODAY_OUTPUT}`);
assert.equal(contents(`${TODAY_INPUT} | ${YESTERDAY_INPUT} | ${TOMORROW_INPUT}`), `${TODAY_OUTPUT}${YESTERDAY_OUTPUT}${TOMORROW_OUTPUT}`);
